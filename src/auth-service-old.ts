...
class AuthService {
  ...
  async verifySession(): Promise<boolean> {
    try {
      console.log("AuthService: Calling /auth/me endpoint...");
      ...
      if (response.ok) {
        ...
        console.log("AuthService: User data received:", data.user);
        this.currentUser = data.user;

        // Create a dummy session object since we're using cookie-based auth
        this.session = {
        ...
        console.log("AuthService: Session data stored successfully");
        return true;
      }

      console.log("AuthService: Response not ok, checking error...");
